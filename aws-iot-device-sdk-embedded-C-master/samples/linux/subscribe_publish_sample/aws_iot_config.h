...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a2jo0n9v19okv3.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_CERTIFICATE_FILENAME   "ff83353bd4-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "ff83353bd4-private.pem.key" ///< Device private key filename
// =================================================
